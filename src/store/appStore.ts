...
export type Section = 'dashboard' | 'planning-rail' | 'planning-auto' | 'planning-arrival' | 'flights-rail' | 'rail-approaches' | 'equipment' | 'requests' | 'accounts' | 'reports' | 'database' | 'monitoring';
